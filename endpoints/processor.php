 ...
 */
function wdbp_wp_forms_test_postcode($postcode)
{
 ...
 */
function wdbp_wp_forms_test_zipcode($zipcode)
{
 ...
 * Form processor
 */
function wdbp_wp_forms_processor( $request_data )
{
    global $wpdb;
     ...
     */
    //$sql = "SELECT * FROM wdbp_wp_forms WHERE form = '" . $data['form'] . "'";
    $sql = $wpdb->prepare('SELECT * FROM wdbp_wp_forms WHERE form = %s', $data['form']);
    ...
    {
        if ( !wdbp_wp_forms_test_zipcode( $data['zipcode'] ) )
        {
    ...
    {
        if ( !wdbp_wp_forms_test_postcode( $data['postcode'] ) )
        {
    ...
    $wpdb->insert( 'wdbp_wp_forms_submissions',
